                ...
                <div className="">
                    ...
                    <div className='flex flex-col'>
                        <div className=' '>
                            ...
                            <h2 className='pb-2 text-md'>Average cost: <span className='font-semibold text-xl t-clr'> ${ac}</span></h2>
                            <h2 className='pb-2 text-md'>Travel Times:<span className='font-semibold text-xl t-clr'> {tt}</span> Days</h2>
                            <h2 className='pb-2 text-md'>Visitors per Year: <span className='font-semibold text-xl t-clr'> {vr}</span></h2>
                        </div>
