        ...
        <div  className={`${theme === 'light' ? 'bg-green-100' : 'dark-theme' } `}>
            <footer className={` footer  p-10  `}>
                <nav>
                    ...
                    <a className="link link-hover">Hiking</a>
                    <a className="link link-hover">Honeymoon</a>
                    <a className="link link-hover">Cruises</a>
                </nav>
                <nav>
                    <h6 className="footer-title text-xl t-clr">Company</h6>
                ...
                <nav>
                    <h6 className="footer-title text-xl t-clr">Country</h6>
                    <a className="link link-hover">Bangladesh</a>
                    <a className="link link-hover">Vietnam</a>
                    <a className="link link-hover">Malaysia</a>
                    <a className="link link-hover">Singapur</a>
                    <a className="link link-hover">Cambodia</a>
                </nav>
                <form>
                    <h6 className="footer-title text-xl t-clr">Newsletter</h6>
                    <fieldset className="form-control w-80">
                        ...
                        <div className="join">
                            ...
                            <button className="btn t-bg join-item">Subscribe</button>
                        </div>
                    </fieldset>
                </form>
